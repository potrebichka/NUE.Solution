    ...
    public class ApplicationDbContext  : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Event>()
                .HasData(
                    new Event { EventId = 1, EventTitle = "ULTRA", Date = new DateTime (2020,02,28,21,0,0), Location ="Bayfront Park", Dj = "Ohm", Video = "https://www.youtube.com/embed/uPlmijjHRvw?autoplay=1&mute=1"},
                    ...
                    new Event { EventId = 4, EventTitle = "OMEGA", Date = new DateTime (2020,04,10,21,0,0), Location = "Seattle Arena", Dj = "Kaskade", Video = "https://www.youtube.com/embed/PbW1FFarLrg?autoplay=1;"},
